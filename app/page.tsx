...
import {
  mergeSoloLevelingBackupIntoLocalStorage,
  parseSoloLevelingBackup,
  replaceSoloLevelingBackupIntoLocalStorage,
  stringifySoloLevelingBackup,
} from "@/lib/solo-leveling-backup";
import {
...
export default function Home() {
  ...
  const [slBackupImportText, setSlBackupImportText] = useState("");
  const [slBackupMsg, setSlBackupMsg] = useState<string | null>(null);
  const [slBackupMergePrefs, setSlBackupMergePrefs] = useState(false);
